...
void main() {
  ...
  // Wave motion
  float noise = snoise(vec3(pos.x * 0.1, pos.y * 0.1, uTime * 0.2));
  pos.z += noise * 2.0;
  
  // Create a rolling wave effect
  float wave = sin(pos.x * 0.2 + uTime * 0.5) * 1.5;
  pos.z += wave;
  ...
  vOpacity = smoothstep(50.0, 10.0, dist);
