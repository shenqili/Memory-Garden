...
const MOCK_MEMORIES: Memory[] = [
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1542259681-d4cd7093e602?q=80&w=800&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1483323326164-9a73824f9f25?q=80&w=800&auto=format&fit=crop'
    ],
    date: 'Dec 24, 2023',
  ...
  },
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1516574187841-693083f05b6e?q=80&w=800&auto=format&fit=crop'
    ],
    date: 'Feb 14, 2024',
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  loadMemory: (id) => {
    ...
    if (mem) {
      set({ currentMemory: mem, phase: 'CHATTING', chatHistory: mem.chatHistory || [] });
    }
  },
